...
public class BlockGrinder extends BlockContainer
{
    ...
    public BlockGrinder(boolean isOn)
    {
        super(Material.rock);
        this.burning = isOn;
    }
    ...
    {
        return Item.getItemFromBlock(Main.grinder);
    }
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(References.MODID + ":grinder_side");
        this.bottomIcon = p_149651_1_.registerIcon(References.MODID + ":grinder_bottom");
        this.topIcon = p_149651_1_.registerIcon(this.burning ? References.MODID + ":grinder_top_on" : References.MODID + ":grinder_top");
    }
    ...
    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        ...
        else
        {
            ...
            {
                p_149727_5_.openGui(Main.getInstance(), 0, p_149727_1_, p_149727_2_, p_149727_3_, p_149727_4_);
            }
     ...
     */
    public static void updateGrinderBlockState(boolean p_149931_0_, World p_149931_1_, int p_149931_2_, int p_149931_3_, int p_149931_4_)
    {
        ...
        if (p_149931_0_)
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, Main.lit_grinder);
        }
        else
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, Main.grinder);
        }
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
    {
        if (this.burning)
        {
            ...
            float f = (float)p_149734_2_ + (float)MathHelper.getRandomDoubleInRange(p_149734_5_, 0.25F, 0.75F);
            float f1 = (float)p_149734_3_ + 1.17F;
            float f2 = (float)p_149734_4_ + (float)MathHelper.getRandomDoubleInRange(p_149734_5_, 0.25F, 0.75F);
